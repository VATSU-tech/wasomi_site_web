...
const appCss = "/assets/styles-gNxoLYUj.css";
...
function ThemeProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    ...
    root.setAttribute("data-theme", theme === "dark" ? "indigo-midnight" : "indigo-light");
    ...
    !(function(e, t) {
      ...
      return (function(e) {
        ...
        var i = Object.assign || function(e2) {
          ...
          return e2;
        }, r2 = n(1), a = (o(r2), n(6)), u = o(a), c = n(7), s = o(c), f = n(8), d = o(f), l = n(9), p = o(l), m = n(10), b = o(m), v = n(11), y = o(v), g = n(14), h = o(g), w = [], k = false, x = { offset: 120, delay: 0, easing: "ease", duration: 400, disable: false, once: false, startEvent: "DOMContentLoaded", throttleDelay: 99, debounceDelay: 50, disableMutationObserver: false }, j = function() {
        ...
        (function(t2) {
          ...
          function o(e2, t3, o2) {
            var r3 = true, a2 = true;
            if ("function" != typeof e2) throw new TypeError(s);
            return i(o2) && (r3 = "leading" in o2 ? !!o2.leading : r3, a2 = "trailing" in o2 ? !!o2.trailing : a2), n(e2, t3, { leading: r3, maxWait: t3, trailing: a2 });
          }
          function i(e2) {
          ...
          function a(e2) {
            return "symbol" == ("undefined" == typeof e2 ? "undefined" : c(e2)) || r2(e2) && k.call(e2) == d;
          }
          function u(e2) {
        ...
        function r2(e2, t2) {
          var n2 = window.document, i2 = o(), r3 = new i2(a);
          u = t2, r3.observe(n2.documentElement, { childList: true, subtree: true, removedNodes: true });
        }
        function a(e2) {
        ...
        t.default = { isSupported: i, ready: r2 };
      }, function(e, t) {
        function n(e2, t2) {
        ...
        var i = /* @__PURE__ */ (function() {
          ...
          return i(e2, [{ key: "phone", value: function() {
            var e3 = o();
            return !(!r2.test(e3) && !a.test(e3.substr(0, 4)));
        ...
        Object.defineProperty(t, "__esModule", { value: true });
        var i = n(12), r2 = o(i), a = function(e2, t2) {
          return e2.forEach(function(e3, n2) {
            e3.node.classList.add("aos-init"), e3.position = (0, r2.default)(e3.node, t2.offset);
          }), e2;
        };
        t.default = a;
      }, function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: true });
        var i = n(13), r2 = o(i), a = function(e2, t2) {
          ...
          switch (a2.offset && !isNaN(a2.offset) && (o2 = parseInt(a2.offset)), a2.anchor && document.querySelectorAll(a2.anchor) && (e2 = document.querySelectorAll(a2.anchor)[0]), n2 = (0, r2.default)(e2).top, a2.anchorPlacement) {
            case "top-bottom":
              break;
            case "center-bottom":
          ...
          children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-primary rounded-lg blur-md opacity-60 group-hover:opacity-100 transition-smooth" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-gradient-primary rounded-lg p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "size-5 text-primary-foreground" }) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg tracking-tight", children: "Wasomi" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden lg:flex items-center gap-1", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      ...
                      children: ({ isActive }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                        l.label,
                        isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-x-3 -bottom-0.5 h-0.5 bg-gradient-primary rounded-full" })
                      ] })
                    }
                  ) }, l.to)) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "size-4 text-foreground" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "size-4 text-foreground" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Link,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "glass rounded-2xl p-3 space-y-1 shadow-elegant", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative mt-32 border-t border-border bg-surface", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 -top-px h-px bg-gradient-to-r from-transparent via-primary to-transparent opacity-50" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-16 max-w-7xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-primary rounded-lg p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "size-5 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg", children: "Wasomi" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Une école d'excellence qui forme les talents de demain à travers des programmes innovants et un accompagnement personnalisé." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [Facebook, Instagram, Linkedin, Twitter].map((Icon2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "#",
              "aria-label": "Social",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold mb-4", children: "Navigation" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold mb-4", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "size-4 mt-0.5 text-primary shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "123 Avenue de l'Éducation, Kinshasa" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-4 text-primary shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+243 000 000 000" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "size-4 text-primary shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "contact@wasomi.school" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold mb-4", children: "Newsletter" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-3", children: "Recevez nos actualités et événements." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Wasomi. Tous droits réservés."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground transition-smooth", children: "Mentions légales" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground transition-smooth", children: "Confidentialité" })
        ] })
      ] })
    ] })
  ] });
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4 bg-mesh", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", "data-aos": "zoom-in", children: [
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "fr", suppressHydrationWarning: true, children: [
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AosProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 pt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
  ] }) }) });
}
const $$splitComponentImporter$6 = () => import("./galerie-Ztwr0hU5.js");
const Route$6 = createFileRoute("/galerie")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explorez la vie du campus Wasomi : événements, réalisations étudiantes, équipements et espaces."
    }, {
      property: "og:title",
      content: "Galerie — Wasomi"
    }, {
      property: "og:description",
      content: "La vie au campus en images."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./formations-D05fcuw8.js");
const Route$5 = createFileRoute("/formations")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Découvrez les formations Wasomi : développement web, design, data, marketing et plus encore."
    }, {
      property: "og:title",
      content: "Formations — Wasomi"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$4 = () => import("./equipe-CWpORhID.js");
const Route$4 = createFileRoute("/equipe")({
  head: () => ({
    meta: [{
      title: "Équipe — Wasomi"
    }, {
      name: "description",
      content: "Rencontrez les enseignants, mentors et experts qui font la richesse de Wasomi."
    }, {
      property: "og:title",
      content: "Équipe — Wasomi"
    }, {
      property: "og:description",
      content: "L'équipe Wasomi."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-B00j5u1Z.js");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Contactez l'école Wasomi. Notre équipe vous répond sous 24h ouvrées."
    }, {
      property: "og:title",
      content: "Contact — Wasomi"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$2 = () => import("./blog-B315wu9u.js");
const Route$2 = createFileRoute("/blog")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Actualités, conseils et histoires inspirantes de la communauté Wasomi."
    }, {
      property: "og:title",
      content: "Blog — Wasomi"
    }, {
      property: "og:description",
      content: "Actualités et conseils."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-xirWxMvQ.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Notre histoire, notre mission, nos valeurs : découvrez ce qui fait Wasomi."
    }, {
      property: "og:title",
      content: "À propos — Wasomi"
    }, {
      property: "og:description",
...
const $$splitComponentImporter = () => import("./index-BqJchslY.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Découvrez Wasomi : programmes innovants, équipe d'experts et accompagnement personnalisé pour révéler votre potentiel."
    }, {
      property: "og:title",
      content: "Wasomi — École d'excellence"
    }, {
      property: "og:description",
      content: "Forme les talents de demain."
    }]
  }),
...
const EquipeRoute = Route$4.update({
  id: "/equipe",
  path: "/equipe",
  getParentRoute: () => Route$7
});
