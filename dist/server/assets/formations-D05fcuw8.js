...
const formations = [{
  ...
  duration: "2 ans",
  students: "120+",
  desc: "Maîtrisez le full-stack moderne : React, Node, Cloud.",
  ...
  duration: "2 ans",
  students: "80+",
  desc: "Concevez des produits désirables avec Figma et la recherche utilisateur.",
  ...
  duration: "3 ans",
  students: "60+",
  desc: "Python, ML, Deep Learning. Devenez expert de la donnée.",
  ...
  duration: "2 ans",
  students: "45+",
  desc: "Pentest, défense, conformité. Protégez les systèmes critiques.",
  ...
  duration: "1 an",
  students: "100+",
  desc: "SEO, Ads, Content, Growth. Maîtrisez tous les leviers digitaux.",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative bg-hero py-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 max-w-7xl relative text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl md:text-6xl font-bold tracking-tight", "data-aos": "fade-up", children: [
          "Nos ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "formations" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 container mx-auto px-4 max-w-7xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: formations.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { "data-aos": "fade-up", "data-aos-delay": i % 3 * 80, className: "group relative p-6 rounded-2xl glass hover:shadow-glow transition-spring hover:-translate-y-2 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/contact", className: "inline-flex items-center gap-2 text-sm font-semibold text-primary group-hover:gap-3 transition-smooth", children: [
          "En savoir plus ",
