...
export const galleryItems: GalleryItem[] = [
  { id: "13", src: s("campus_1.jpg"), title: "Pelouse centrale", category: "Campus", description: "Espace de détente et d'événements en plein air.", featured: true  },
  {id: "1", src: u("photo-1551434678-e076c223a692"), title: "Campus principal", category: "Campus", description: "Notre bâtiment historique au cœur de la ville."},
