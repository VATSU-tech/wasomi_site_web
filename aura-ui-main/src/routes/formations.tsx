...
import { Code2, Palette, BarChart3, Cpu, Megaphone, Briefcase, ArrowRight, Clock, Users } from "lucide-react";
...
export const Route = createFileRoute("/formations")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Découvrez les formations Wasomi : développement web, design, data, marketing et plus encore." },
      { property: "og:title", content: "Formations — Wasomi" },
      { property: "og:description", content: "Programmes innovants pour révéler votre talent." },
    ],
  }),
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="flex items-center gap-4 text-xs text-muted-foreground mb-5">
                  <span className="inline-flex items-center gap-1"><Clock className="size-3.5" />{f.duration}</span>
                  <span className="inline-flex items-center gap-1"><Users className="size-3.5" />{f.students}</span>
                </div>
                <Link
                  to="/contact"
